...
class ModelRandomForestTest(unittest.TestCase):
    ...
    def testLinearRegression(self):
        ...
        regressor = ta.RandomForestRegressorModel(name=model_name)
        

        print "Training the model on the Frame"
        regressor.train(frame,'GXY',['Age','Sex','Height','Weight','BMI','DBP','SBP','HCT','MCV','RDW_SD',
        ...
        self.assertEqual(regressor_output.column_names, ['GXY','Age','Sex','Height','Weight','BMI','DBP','SBP','HCT',
