...
class ModelSvmTest(unittest.TestCase):
    ...
    def testSvm(self):
        ...
        print "Initializing a ModelSvmModel object"
        model_name = 'POCModelSvmModel'
        exist_models = ta.get_model_names()
        if model_name in exist_models:
            print "Model exist, delete"
            ta.drop_models(model_name)
        svm = ta.SvmModel(name=model_name)

        print "Training the model on the Frame"
        svm.train(train_frame,'GXY',['Age','Sex','Height','Weight','BMI','DBP','SBP','HCT','MCV','RDW_SD',
        ...
        output = svm.predict(train_frame)
